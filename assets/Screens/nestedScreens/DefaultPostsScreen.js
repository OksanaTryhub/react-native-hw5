    ...
    return (
        ...
        <FlatList
            ...
            <View style={styles.postWrap}> 
                    <Image source={{ uri: item.state.myPhoto }} style={styles.imagePost} />
                    <Text style={styles.titlePost}> {item.state.title}</Text>
                    <View style={styles.marksWrap}>
                        ...
                        <TouchableOpacity style= {styles.location} onPress={() => navigation.navigate("Map")}>
                            ...
                            <Text style={styles.locationTitle }>{item.state.location}</Text>
                        </TouchableOpacity>
                    </View>
            </View>
            )
